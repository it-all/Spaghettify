...
class SystemEventsView extends ListView
{
    public function __construct(Container $container)
    {
        ...
        parent::__construct($container, 'systemEventsFilterColumnsInfo', 'systemEventsFilterValue', 'systemEventsFilter', ROUTE_SYSTEM_EVENTS, $container->systemEvents, ROUTE_SYSTEM_EVENTS_RESET);
    }
}
